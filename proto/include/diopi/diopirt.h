...
extern DIOPI_RT_API DIOPI_ATTR_WEEK diopiError_t diopiGetTensorCrowIndices(diopiConstTensorHandle_t th, diopiTensorHandle_t* crow_indices);
extern DIOPI_RT_API DIOPI_ATTR_WEEK diopiError_t diopiGetTensorColIndices(diopiConstTensorHandle_t th, diopiTensorHandle_t* col_indices);
extern DIOPI_RT_API DIOPI_ATTR_WEEK diopiError_t diopiGetTensorValues(diopiConstTensorHandle_t th, diopiTensorHandle_t* values);
extern DIOPI_RT_API DIOPI_ATTR_WEEK diopiError_t diopiIsTensorSparse(diopiConstTensorHandle_t th, bool* is_sparse);
