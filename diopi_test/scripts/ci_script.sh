...
cpp-lint)
  ...
  echo "cpp-lint"
  python scripts/cpplint.py --exclude=impl/third_party/ --linelength=160 --filter=-build/c++11,-legal/copyright,-build/include_subdir, -runtime/references,-runtime/printf,-runtime/int,-build/namespace --recursive impl/
