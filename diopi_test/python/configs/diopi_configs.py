            ...
            args=[
                {
                    ...
                    "shape": ((3, 32, 128), (3, 32, 128), (2, 15, 32), (0, 5, 16), (2, 15, 32)),
                    "dtype": [np.float16, np.float32, np.float64],
                },
                {
                    "ins": ["k"],
                    # "shape": ((100, 32, 128), (100, 32, 128), (6, 16, 16), (20, 15, 32), (35, 7, 64), (19, 5, 16), (0, 15, 32)),
                    "shape": ((100, 32, 128), (100, 32, 128), (20, 15, 32), (19, 5, 16), (0, 15, 32)),
                    "dtype": [np.float16, np.float32, np.float64],
                },
                {
                    "ins": ["out"],
                    # "shape": ((32, 13), (32, 38), (16, 6), (15, 11), (7, 6), (5, 0), (15, 0)),
                    "shape": ((32, 13), (32, 38), (15, 11), (5, 0), (15, 0)),
                    "dtype": [np.float16, np.float32, np.float64],
                },
                {
                    "ins": ["b_loc"],
                ...
                },
                {
                    ...
                    "value": ([0, 4, 9], [2, 11, 34, 99, 1001], [0, 5], [], [0, 0]),
                    "dtype": [np.int32, np.int64, np.int32],
                    "gen_policy": "gen_tensor_by_value"
                },
                {
