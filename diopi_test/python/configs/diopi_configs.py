    ...
    'attention': dict(
        ...
        tensor_para=dict(
            ...
            args=[
                {
                    "ins": ['query'],
                    "shape": ((1, 64, 64, 128), (1, 16, 256, 128), (1, 32, 64, 512), (8, 128, 32, 256),
                              (2, 64, 128, 128), (4, 16, 512, 128), (6, 32, 32, 128), (8, 8, 1024, 64),
                              (2, 128, 64 * 128), (4, 512, 128), (6, 32, 256), (8, 1024, 8 * 64),
                              (2, 64, 512, 128), (4, 16, 256, 128), (6, 32, 128, 128), (8, 8, 64, 64),
                              (512, 8, 8, 16), (8, 256, 512, 512), (16, 256, 512, 128), (31, 128, 512, 512),),
                    "requires_grad": [True],
                },
                {
                    "ins": ['key'],
