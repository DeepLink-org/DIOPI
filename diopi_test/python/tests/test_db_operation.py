...
case_device_case = {
    'test backward case': dict(insert_benchmark_case=[dict(case_name='test_batch_norm_batch_norm_0', model_name='diopi', inplace_flag=0, backward_flag=1,
                          ...
                          expect_funclist=dict(diopiBatchNorm=dict(not_implemented_flag=0, case_num=1,
                                               ...
                                               diopiBatchNormBackward=dict(not_implemented_flag=0, case_num=1,
                                                                      success_case=1, failed_case=0, skipped_case=0)),
                          expect_summary=dict(total_case=1, success_case=1, failed_case=0, skipped_case=0,
    ...
    'test three case some failed': dict(insert_benchmark_case=[dict(case_name='test_batch_norm_batch_norm_0', model_name='diopi', inplace_flag=0, backward_flag=1,
                          ...
                          expect_summary=dict(total_case=3, success_case=1, failed_case=1, skipped_case=1,
    ...
    'test not impl': dict(insert_benchmark_case=[dict(case_name='test_batch_norm_batch_norm_0', model_name='diopi', inplace_flag=0, backward_flag=1,
                          ...
                          expect_funclist=dict(diopiBatchNorm=dict(not_implemented_flag=0, case_num=1,
                                               ...
                                               diopihardswishInp=dict(not_implemented_flag=0, case_num=1,
                                                                      success_case=0, failed_case=0, skipped_case=1)),
                          expect_summary=dict(total_case=3, success_case=1, failed_case=2, skipped_case=0,
    ...
    'test all failed': dict(insert_benchmark_case=[dict(case_name='test_batch_norm_batch_norm_0', model_name='diopi', inplace_flag=0, backward_flag=1,
                          ...
                          expect_funclist=dict(diopiBatchNorm=dict(not_implemented_flag=0, case_num=1,
                                               ...
                                               diopihardswishInp=dict(not_implemented_flag=0, case_num=1,
                                                                      success_case=0, failed_case=1, skipped_case=0)),
                          expect_summary=dict(total_case=3, success_case=0, failed_case=3, skipped_case=0,
                                              total_func=7, impl_func=7)
                          ),
    'test nv failed case': dict(insert_benchmark_case=[dict(case_name='test_batch_norm_batch_norm_0', model_name='diopi', inplace_flag=0, backward_flag=1,
                          ...
                          expect_funclist=dict(diopiBatchNorm=dict(not_implemented_flag=0, case_num=1,
                                               ...
                                               diopiBatchNormBackward=dict(not_implemented_flag=0, case_num=1,
                                                                      success_case=0, failed_case=0, skipped_case=1)),
                          expect_summary=dict(total_case=1, success_case=0, failed_case=1, skipped_case=0,
                                              total_func=2, impl_func=2)
                          ),
    'test inplace scalar case': dict(insert_benchmark_case=[dict(case_name='test_add_add_0', model_name='diopi', inplace_flag=1, backward_flag=0,
                                                  func_name='add', case_config={}, result='skipped'),
                                                            dict(case_name='test_add_add_1', model_name='diopi', inplace_flag=1, backward_flag=1,
                                                  func_name='add', case_config={}, result='skipped'),
                                                            dict(case_name='test_add_add_scalar', model_name='diopi', inplace_flag=1, backward_flag=0,
                                                  func_name='add', case_config={}, result='skipped'),
                                                            dict(case_name='test_sub_sub_0', model_name='diopi', inplace_flag=0, backward_flag=0,
                                                  func_name='sub', case_config={}, result='skipped'),
                                                            dict(case_name='test_mul_mul_0', model_name='diopi', inplace_flag=1, backward_flag=0,
                                                  func_name='mul', case_config={}, result='skipped'),
                                                            dict(case_name='test_mul_mul_scalar', model_name='diopi', inplace_flag=1, backward_flag=0,
                                                  func_name='mul', case_config={}, result='skipped'),],
                          update_benchmark_case=[dict(case_name='test_add_add_0', model_name='diopi', result='passed'),
                          ...
                          insert_device_case=[dict(case_name='test_add_add_0', model_name='diopi',
                                            pytest_nodeid='gencases/diopi_case/test_diopi_add_add_0.py', inplace_flag=1, backward_flag=0,
                                            func_name='add', case_config={}, result='skipped'),
                                              dict(case_name='test_add_add_1', model_name='diopi',
                                            pytest_nodeid='gencases/diopi_case/test_diopi_add_add_1.py', inplace_flag=1, backward_flag=1,
                                            func_name='add', case_config={}, result='skipped'),
                                              dict(case_name='test_add_add_scalar', model_name='diopi',
                                            pytest_nodeid='gencases/diopi_case/test_diopi_add_add_scalar.py', inplace_flag=1, backward_flag=0,
                                            func_name='add', case_config={}, result='skipped'),
                                              dict(case_name='test_sub_sub_0', model_name='diopi',
                                            pytest_nodeid='gencases/diopi_case/test_diopi_sub_sub_0.py', inplace_flag=1, backward_flag=0,
                                            func_name='sub', case_config={}, result='skipped'),
                                              dict(case_name='test_mul_mul_0', model_name='diopi',
                                            pytest_nodeid='gencases/diopi_case/test_diopi_mul_mul_0.py', inplace_flag=1, backward_flag=0,
                                            func_name='mul', case_config={}, result='skipped'),
                                              dict(case_name='test_mul_mul_scalar', model_name='diopi',
                                            pytest_nodeid='gencases/diopi_case/test_diopi_mul_mul_scalar.py', inplace_flag=1, backward_flag=0,
                                            func_name='mul', case_config={}, result='skipped'),],
                          update_device_case=[dict(pytest_nodeid='gencases/diopi_case/test_diopi_add_add_0.py',
                                                   diopi_func_name='diopiAddInp', result='passed'),
                                              dict(pytest_nodeid='gencases/diopi_case/test_diopi_add_add_1.py',
                                                   diopi_func_name='diopiAddInp', result='failed'),
                                              dict(pytest_nodeid='gencases/diopi_case/test_diopi_add_add_scalar.py',
                                                   diopi_func_name='diopiAddInpScalar', result='passed'),
                                              dict(pytest_nodeid='gencases/diopi_case/test_diopi_sub_sub_0.py',
                                                   diopi_func_name='diopiSubInp', result='passed'),
                                              dict(pytest_nodeid='gencases/diopi_case/test_diopi_mul_mul_0.py',
                                                   diopi_func_name='diopiMulInp', result='passed'),
                                              dict(pytest_nodeid='gencases/diopi_case/test_diopi_mul_mul_scalar.py',
                                                   diopi_func_name='diopiMulInpScalar', not_implemented_flag=1, result='failed'),],
                          expect_funclist=dict(diopiAdd=dict(not_implemented_flag=0, case_num=2,
                                                                      success_case=2, failed_case=0, skipped_case=0),
                                               diopiAddInp=dict(not_implemented_flag=0, case_num=2,
                                                                      success_case=1, failed_case=1, skipped_case=0),
                                               diopiAddBackward=dict(not_implemented_flag=0, case_num=1,
                                                                      success_case=1, failed_case=0, skipped_case=0),
                                               diopiAddScalar=dict(not_implemented_flag=0, case_num=1,
                                                                      success_case=1, failed_case=0, skipped_case=0),
                                               diopiAddInpScalar=dict(not_implemented_flag=0, case_num=1,
                                                                      success_case=1, failed_case=0, skipped_case=0),
                                               diopiSub=dict(not_implemented_flag=0, case_num=1,
                                                                      success_case=1, failed_case=0, skipped_case=0),
                                               diopiSubInp=dict(not_implemented_flag=0, case_num=1,
                                                                      success_case=1, failed_case=0, skipped_case=0),
                                               diopiMul=dict(not_implemented_flag=0, case_num=1,
                                                                      success_case=1, failed_case=0, skipped_case=0),
                                               diopiMulInp=dict(not_implemented_flag=0, case_num=1,
                                                                      success_case=1, failed_case=0, skipped_case=0),
                                               diopiMulScalar=dict(not_implemented_flag=0, case_num=1,
                                                                      success_case=1, failed_case=0, skipped_case=0),
                                               diopiMulInpScalar=dict(not_implemented_flag=1, case_num=1,
                                                                      success_case=0, failed_case=1, skipped_case=0),),
                          expect_summary=dict(total_case=6, success_case=4, failed_case=2, skipped_case=0,
                                              total_func=11, impl_func=10)
    )
}
