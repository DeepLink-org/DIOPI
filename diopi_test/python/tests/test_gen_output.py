...
case_cfg_map = {
    ...
    'test cat requires_grad': {'cat_diff_size::cat_14.pth': {'atol': 0.0001, 'rtol': 1e-05, 'atol_half': 0.01, 'rtol_half': 0.05, 'mismatch_ratio_threshold': 0.001, 'memory_format': 'NCHW', 'fp16_exact_match': False, 'train': True, 'gen_policy': 'dafault', 'name': 'cat', 'interface': ['torch'], 'para': {'dim': 2}, 'tensor_para': {'args': [{'ins': 'tensors', 'requires_grad': [True], 'shape': ((2, 31, 0), (2, 31, 512), (2, 31, 128)), 'dtype': np.float64, 'gen_policy': 'gen_tensor_list_diff_shape', 'gen_fn': 'Genfunc.randn', 'gen_num_range': []}], 'seq_name': ''}, 'requires_backward': [], 'tag': [], 'saved_args': {}}},
    'test inplace requires_grad': {'unfold::unfold_0.pth': {'atol': 0.0001, 'rtol': 1e-05, 'atol_half': 0.01, 'rtol_half': 0.05, 'mismatch_ratio_threshold': 0.001, 'memory_format': 'NCHW', 'fp16_exact_match': False, 'train': True, 'gen_policy': 'dafault', 'name': 'unfold', 'interface': ['torch.Tensor'], 'para': {'dimension': 2, 'size': 2, 'step': 1}, 'tensor_para': {'gen_fn': 'Genfunc.randn', 'args': [{'ins': 'input', 'requires_grad': [True], 'shape': (2, 128, 56, 56), 'dtype': np.float32, 'gen_num_range': [], 'gen_fn': 'Genfunc.randn', 'gen_policy': 'default'}], 'seq_name': ''}, 'requires_backward': [], 'tag': [], 'saved_args': {}}},
    'test output is tuple': {'cholesky::cholesky_ex_1.pth': {'atol': 1e-05, 'rtol': 1e-05, 'atol_half': 0.01, 'rtol_half': 0.05, 'mismatch_ratio_threshold': 0.001, 'memory_format': 'NCHW', 'fp16_exact_match': False, 'train': True, 'gen_policy': 'dafault', 'name': 'cholesky_ex', 'interface': ['torch.linalg'], 'para': {'upper': False, 'check_errors': False}, 'tensor_para': {'args': [{'ins': 'input', 'requires_grad': [True], 'shape': (2, 3, 3), 'dtype': np.float32, 'gen_fn': 'Genfunc.sym_mat', 'gen_num_range': [], 'gen_policy': 'default'}], 'seq_name': ''}, 'requires_backward': [0], 'saved_args': {'output': 0}, 'tag': []}}
