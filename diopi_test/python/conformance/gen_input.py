...
class GenTensor(object):
    ...
    def gen_tensor_list(self):
        ...
        tensors_num = np.random.randint(self.arg['gen_num_range'][0],
                                        self.arg['gen_num_range'][1])
    ...
    def parse_gen_fn(self, gen_fn):
        if isinstance(gen_fn, dict):
            ...
            if gen_fn == Genfunc.randint or gen_fn == Genfunc.uniform or gen_fn == Genfunc.randn_int:
...
if __name__ == '__main__':
    ...
    cfg = {'atol': 1e-05,
           ...
           'memory_format': 'NCHW', 
           'fp16_exact_match': False, 'train': True, 'gen_policy': 'dafault', 'name': 'clip_grad_norm_', 
