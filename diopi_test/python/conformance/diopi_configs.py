...
diopi_configs = {
    ...
    'addmm': dict(
        ...
        rtol=1e-5,
        para=dict(
            alpha=[0.001, -0.01, 1, 0, -3, -0.01, 1, 0.12, 1., 2.1, -1.2, True],
            beta=[0.001, -0.01, 1, 2, 0, -0.01, 1, False, 1., -1.2, 2.3, 1e-2],
        ),
        tensor_para=dict(
            gen_fn=Genfunc.randn,
    ...
    'addcdiv': dict(
        ...
        rtol=1e-5,
        para=dict(
            value=[0, -0.001, -0.01, 2, -1e-5, -3, 0.75, -1.44, 9, 0, 1., 2.5],
        ),
        tensor_para=dict(
            gen_fn=Genfunc.randn,
            dtype=[Dtype.float16, Dtype.float32, Dtype.float64],
            ...
            args=[
                {
                    ...
                    "dtype": [Dtype.float32, Dtype.float64, Dtype.float32, Dtype.float32, Dtype.float64],
                    "gen_fn": Genfunc.randn,
                },
                {
                    "ins": ['targets'],
                    "shape": ((20, 10), (20, 14), (20, 11), (20, 54)),
                    "dtype": [Dtype.int64, Dtype.int8, Dtype.int16, Dtype.int32, Dtype.uint8],
                    "gen_fn": dict(fn=Genfunc.randint, low=0, high=80),
                },
                {
                    "ins": ['input_lengths'],
                    "shape": ((20, ), (20, ), (20, ), (20, )),
                    "dtype": [Dtype.int64, Dtype.uint8, Dtype.int32, Dtype.int8, Dtype.int16],
                    "gen_fn": dict(fn=Genfunc.randint, low=1, high=26),
                },
                {
                    "ins": ['target_lengths'],
                    "shape": ((20, ), (20, ), (20, ), (20, )),
                    "dtype": [Dtype.int64, Dtype.int16, Dtype.int8, Dtype.uint8, Dtype.int32],
    ...
    'remainder': dict(
        ...
        rtol=1e-5,
        para=dict(
            self=[2, 4.3, 10.1, 1, 100., -2.5, -3, -1, 0.23, 0],
        ),
        tensor_para=dict(
            gen_fn=Genfunc.randn,
            args=[
