...
diopi_configs = {
    ...
    'binary_cross_entropy': dict(
        ...
        tensor_para=dict(
            ...
            args=[
                ...
                {
                    "ins": ['weight'],
                    "shape": ((72,), (2, 11856), (2, 741, 80), (16, 20)),
                    "dtype": [Dtype.float16, Dtype.float32,
                              Dtype.int16, Dtype.int32, 
                              Dtype.int8],
                },
        ...
        tensor_para=dict(
            ...
            args=[
                ...
                },
                {
                    "ins": ['pos_weight'],
                    "shape": ((72,),
                              (11856,), (2, 741, 80,), (4, 16, 20), (4, 1), (16,)),
                    "dtype": [Dtype.float16, Dtype.int32,
    ...
    'pointwise_op_int_without_inplace': dict(
        ...
        name=['abs', 'cos', 'erf', 'exp',
              'neg', 'sin', 'asin', 'sqrt', 'logical_not', 'rsqrt', 'atan'],
        interface=['torch'],
        dtype=[Dtype.int16, Dtype.int32, Dtype.int8],
        tensor_para=dict(
    ...
    'pointwise_binary': dict(
        ...
        interface=['torch'],
        is_inplace=True,
        dtype=[ Dtype.float32, Dtype.float16, Dtype.int32, Dtype.int16, Dtype.int8],
        tensor_para=dict(
            gen_fn=Genfunc.randn,
            args=[
                {
    ...
    'bmm': dict(
        ...
        tensor_para=dict(
            ...
            args=[
                {
                    "ins": ['input'],
                    "shape": ((16, 726, 32), (16, 100, 100), (9, 5, 5), (5, 8, 13)),
                },
                {
                    "ins": ['mat2'],
                    "shape": ((16, 32, 726), (16, 100, 32), (9, 5, 10), (4, 6, 8)),
                },
            ],
        ),
    ),
    ...
    'addcdiv_addcmul_without_inplace': dict(
        ...
        tensor_para=dict(
            ...
            args=[
                ...
                {
                    "ins": ["tensor2"],
                    "shape": ((5, 128), (3, 128, ), (2, 576, 1), (3, 3, 3), (10, 1, 5), (9,)),
                },
            ],
        ),
    ),
            ...
            args=[
                {
                    ...
                    "shape": ((64, ), (169, 4), (17100, 2), (1, 1, 384),
                              (4, 133, 128, 128), (2, 64, 3, 3, 3)),
                    "dtype": [Dtype.float16, Dtype.float32,
                              Dtype.int16, Dtype.int32, Dtype.int8],
                    "gen_fn": Genfunc.randn,
                },
            ],
        ),
    ...
    #                 "dtype": [ Dtype.int32, Dtype.float16,
    #                           Dtype.float32, Dtype.int16,
    #                           Dtype.int8, Dtype.float16, Dtype.float32]
    #             },
    #             {
    #                 "ins": ['target'],
    #                 "shape": ((2, 11856, 2), (16, 2, 2964, 2), (2964, 32)),
    #                 "dtype": [Dtype.int16, Dtype.float32, 
            ...
            args=[
                {
                    ...
                    "dtype": [Dtype.int32, Dtype.int16, Dtype.int8],
                    "gen_fn": Genfunc.randn
                },
                {
                    "ins": ['index'],
        ...
        tensor_para=dict(
            args=[
                ...
                },
                {
                    ...
                    #           (0,), (1,), (9,)),
                    "shape": ((16,), (12, 13), (12, 13, 14), (12, 13, 14, 1), (1, 4), (1,), (9,)),
                    "dtype": [Dtype.bool],
                    "gen_fn": Genfunc.mask
                },
                {
                    ...
                    #           (0,), (3, 4), (2,)),
                    "shape": ((16,), (12, 13), (12, 13, 14), (12, 13, 14, 16), (1, 20), (3, 4), (2,)),
                    "dtype": [Dtype.float32, Dtype.float16, Dtype.int16,
                              Dtype.int32, Dtype.int8],
                    "gen_fn": Genfunc.randn
                },
            ...
            args=[
                {
                    "ins": ['input'],
                    "requires_grad": [True],
                    "shape": ((13,), (78, 24), (2, 92, 29), (2, 150, 512, 512), (26, 20, 38)),
                    "dtype": [Dtype.float16, Dtype.float32],
                    "gen_fn": Genfunc.randn,
                },
            ],
    ...
    'imum_broadcast': dict(
        ...
        tensor_para=dict(
            args=[
                ...
                {
                    "ins": ['other'],
                    "shape": ((5,), (4, 12), (1, 128, 128), (256, 8, 8), (5, 6, 6, 7), (4, 1, 5)),
    ...
    'permute': dict(
        ...
        tensor_para=dict(
            args=[
                {
                    "ins": ['input'],
                    "shape": [(2, 8, 7, 8, 7, 128), (49, 49, 4), (2, 3, 200, 304), (20267, 1), (2, 3, 4), (1,)],
                    "gen_fn": Genfunc.randn,
                    "dtype": [Dtype.float32, Dtype.float16, Dtype.int16,
                              Dtype.int32, Dtype.int8],
                },
            ...
            args=[
                {
                    ...
                    # "dtype": [Dtype.float32, Dtype.float32, Dtype.float32],
                    "dtype": [Dtype.float32],
                    "gen_fn": Genfunc.randn,
                },
                {
                ...
                },
                {
                    "ins": ['input_lengths'],
                    "shape": ((20, ), (20, ), (20, ), (20, )),
                    # "dtype": [Dtype.int32, Dtype.int8, Dtype.int16],
                    "dtype": [Dtype.int64],
                ...
                },
                {
                    "ins": ['target_lengths'],
                    "shape": ((20, ), (20, ), (20, ), (20, )),
                    # "dtype": [Dtype.int16, Dtype.int8, Dtype.int32],
                    "dtype": [Dtype.int64],
            ...
            args=[
                ...
                },
                {
                    ...
                    "shape": ((6, ), (4, 1), (4, 5), (3, 4, 5), (28, 28),
                              (16, 3, 7, 14, 14)),
                    "dtype": [Dtype.int32, Dtype.int32,
                              Dtype.float16, Dtype.int8, Dtype.float32],
                    "gen_fn": dict(fn=Genfunc.randn_int, low=-4, high=4),
                },
            ],
        ),
    ...
    'copy_different_dtype': dict(
        ...
        tensor_para=dict(
            ...
            args=[
                ...
                {
                    "ins": ["other"],
                    "dtype": [ Dtype.float16, Dtype.float16,
                              Dtype.int32, Dtype.float32],
            ...
            args=[
                {
                    ...
                    "dtype": [Dtype.float32, Dtype.int8],
                },
                {
                    "ins": ['out'],
                    "shape": [(32, 64,), (128, 24, 32), (16, 8,), (24, 12,)],
