...
dtype_op = {
    "nll_loss": ["target"],  # input using int32/float32 type
...
dtype_out_op = {
    "max_pool2d": ["indices"],  # out using int32/float32 type
    "max_pool3d": ["indices"],
...
ops_with_states = {
    ...
    "fused_adamw": {"params", "exp_avgs", "exp_avg_sqs", "max_exp_avg_sqs"},
    ...
    "apply_penalty_v2": {"logits"},
    "rotary_emb_v2": {"query", "key"},
