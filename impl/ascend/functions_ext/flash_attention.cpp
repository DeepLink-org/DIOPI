 ...
 * @param[out] gen Handle for the random number generator used in h op.
 */
diopiError_t diopiFlashAttention(diopiContextHandle_t ctx, diopiTensorHandle_t attentionOut, diopiTensorHandle_t* softmaxMax, diopiTensorHandle_t* softmaxSum,
    ...
    AscendTensor outTensor(attentionOut);
    ...
    // int64_t preTockensOptional,
    // int64_t nextTockensOptional,
    // int64_t headNum,
    // char *inputLayout,
