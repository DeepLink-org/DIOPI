...
device_configs = {
    ...
    'pointwise_op': dict(
        name=['erf', 'erfinv', 'exp', 'neg', 'asin', 'sqrt', 'rsqrt', 'ceil', 'atan'],
        tensor_para=dict(
            args=[
                {
                    "ins": ['input'],
    ...
    'pointwise_op_int_without_inplace': dict(
        name=['erf', 'exp', 'neg', 'asin', 'sqrt', 'rsqrt', 'atan'],
        tensor_para=dict(
            args=[
                {
                    "ins": ['input'],
    ...
    'index': dict(
        ...
        tensor_para=dict(
            args=[
                {
                    "ins": ['input'],
                    "shape": [Skip((128, 2, 2)),Skip((2, 3, 224, 224)),Skip((3, 2, 6, 197, 64)),],
                },
            ]
        ),
    ),
