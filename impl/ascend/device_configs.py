...
device_configs = {
    ...
    'pointwise_op': dict(
        name=['abs', 'erf', 'erfinv', 'exp', 'floor', 'neg', 'asin', 'sqrt', 'logical_not', 'rsqrt', 'ceil', 'atan'],
        tensor_para=dict(
            args=[
                {
                    "ins": ['input'],
    ...
    'tanh': dict(
        ...
        tensor_para=dict(
            args=[
                {
                    "ins": ['input'],
                    "shape": [Skip((1,)),Skip((1024,)),Skip((364800, 4)),Skip((2, 128, 3072)),Skip((256, 128, 3, 3)),Skip((2, 31, 512, 6, 40)),Skip((0,)),Skip((16, 0)),Skip((1, 0, 6))],
                },
            ]
        ),
    ),
    ...
    'clamp_tensor': dict(
        ...
        tensor_para=dict(
            args=[
                {
                    "ins": ['input'],
                    "shape": [Skip((182,)),Skip((384, 128)),Skip((2, 4, 100, 152)),Skip((0,)),Skip((2, 0,)),Skip((16, 0, 9)),],
                },
            ]
        ),
    ),
    ...
    'copy': dict(
        ...
        tensor_para=dict(
            args=[
                {
                    "ins": ['input'],
                    "shape": [Skip((192, 147)),Skip((1, 1, 384)),Skip((2, 1, 38, 45)),],
                },
            ]
        ),
    ),
