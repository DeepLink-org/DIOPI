...
int64_t npu_change_data_ptr(const at::Tensor &dst, const at::Tensor &src, int64_t index){CUSTOM_OP_NOT_IMPL} int64_t get_npu_format(const at::Tensor &self) {
    CUSTOM_OP_NOT_IMPL
}
__attribute__((__visibility__("default"))) at::Tensor npu_format_cast(const at::Tensor &self, const at::Tensor &dst){
    CUSTOM_OP_NOT_IMPL} at::Tensor &npu_format_cast_(at::Tensor &self, int64_t acl_format){
    CUSTOM_OP_NOT_IMPL} at::Tensor &npu_format_cast_(at::Tensor &self, const at::Tensor &src){CUSTOM_OP_NOT_IMPL} at::Tensor
    empty_with_format(at::IntArrayRef size, c10::optional<at::ScalarType> dtype, c10::optional<at::Layout> layout, c10::optional<at::Device> device,
                      c10::optional<bool> pin_memory, int64_t acl_format){CUSTOM_OP_NOT_IMPL} at::Tensor
    unsafe_empty_with_format(at::IntArrayRef size, c10::optional<at::ScalarType> dtype, c10::optional<at::Layout> layout, c10::optional<at::Device> device,
                             c10::optional<bool> pin_memory, int64_t acl_format, bool keep_format){CUSTOM_OP_NOT_IMPL} at::Tensor
    empty_with_format(at::IntArrayRef size, c10::optional<at::DimnameList> names, c10::optional<at::ScalarType> dtype, c10::optional<at::Layout> layout,
                      c10::optional<at::Device> device, c10::optional<bool> pin_memory, int64_t acl_format){
        CUSTOM_OP_NOT_IMPL} at::Tensor &copy_memory_(at::Tensor &self, const at::Tensor &src, bool non_blocking){CUSTOM_OP_NOT_IMPL} at::Tensor
    format_contiguous(const at::Tensor &self) {
    CUSTOM_OP_NOT_IMPL
}
bool check_match(const at::Tensor &self) { CUSTOM_OP_NOT_IMPL }
void check_memory_overlaps(at::TensorList inputs, at::TensorList outputs){CUSTOM_OP_NOT_IMPL} int64_t get_storage_size(const at::Tensor &self) {
    CUSTOM_OP_NOT_IMPL
}
__attribute__((__visibility__("default"))) at::Tensor npu_format_cast(const at::Tensor &self, int64_t acl_format){CUSTOM_OP_NOT_IMPL} at::Tensor
    _npu_format_cast(const at::Tensor &self, int64_t acl_format){CUSTOM_OP_NOT_IMPL} at::Tensor &npu_view_copy(at::Tensor &self, const at::Tensor &other,
                                                                                                               bool non_blocking){CUSTOM_OP_NOT_IMPL} at::Tensor
    npu_transpose(const at::Tensor &self, at::IntArrayRef perm, bool require_contiguous){
        CUSTOM_OP_NOT_IMPL} at::Tensor &npu_transpose_out(const at::Tensor &self, at::IntArrayRef perm, bool require_contiguous,
                                                          at::Tensor &out){CUSTOM_OP_NOT_IMPL} at::Tensor
    npu_broadcast(const at::Tensor &self, at::IntArrayRef size){CUSTOM_OP_NOT_IMPL} at::Tensor &npu_broadcast_out(const at::Tensor &self, at::IntArrayRef size,
                                                                                                                  at::Tensor &out){CUSTOM_OP_NOT_IMPL}

at::Tensor &npu_dtype_cast_(at::Tensor &self, const at::Tensor &src) {
    return acl_op::npu_dtype_cast_(self, src);
}

at::Tensor npu_alloc_float_status(const at::Tensor &self){CUSTOM_OP_NOT_IMPL} at::Tensor
    npu_get_float_status(const at::Tensor &self){CUSTOM_OP_NOT_IMPL} at::Tensor
    npu_clear_float_status(const at::Tensor &self){CUSTOM_OP_NOT_IMPL} at::Tensor &one_(at::Tensor &self){CUSTOM_OP_NOT_IMPL} at::Tensor
    fast_gelu(const at::Tensor &self){CUSTOM_OP_NOT_IMPL} at::Tensor npu_fast_gelu_backward(const at::Tensor &grad, const at::Tensor &self) {
    CUSTOM_OP_NOT_IMPL
}
bool _amp_foreach_non_finite_check(at::TensorList scaled_grads){CUSTOM_OP_NOT_IMPL} at::Tensor npu_sign_bits_pack(const at::Tensor &self, int64_t size) {
    CUSTOM_OP_NOT_IMPL
}
...
::std::tuple<at::Tensor, at::Tensor, at::Tensor> npu_convolution_backward(const at::Tensor &input, const at::Tensor &grad_output, const at::Tensor &weight,
                                                                          ...
                                                                          int64_t groups, ::std::array<bool, 3> output_mask){CUSTOM_OP_NOT_IMPL} at::Tensor
    npu_conv_transpose2d(const at::Tensor &input, const at::Tensor &weight, const c10::optional<at::Tensor> &bias, at::IntArrayRef padding,
                         at::IntArrayRef output_padding, at::IntArrayRef stride, at::IntArrayRef dilation, int64_t groups){CUSTOM_OP_NOT_IMPL} at::Tensor
    npu_conv2d(const at::Tensor &input, const at::Tensor &weight, const c10::optional<at::Tensor> &bias, at::IntArrayRef stride, at::IntArrayRef padding,
               at::IntArrayRef dilation, int64_t groups){
        CUSTOM_OP_NOT_IMPL} at::Tensor &npu_conv2d_out(const at::Tensor &input, const at::Tensor &weight, const c10::optional<at::Tensor> &bias,
...
::std::tuple<at::Tensor, at::Tensor, at::Tensor> npu_conv2d_backward(const at::Tensor &input, const at::Tensor &grad_output, const at::Tensor &weight,
    ...
    CUSTOM_OP_NOT_IMPL} at::Tensor npu_conv3d(const at::Tensor &input, const at::Tensor &weight, const c10::optional<at::Tensor> &bias, at::IntArrayRef stride,
                                              at::IntArrayRef padding, at::IntArrayRef dilation, int64_t groups){
    CUSTOM_OP_NOT_IMPL} at::Tensor &npu_conv3d_out(const at::Tensor &input, const at::Tensor &weight, const c10::optional<at::Tensor> &bias,
                                                   at::IntArrayRef stride, at::IntArrayRef padding, at::IntArrayRef dilation, int64_t groups, at::Tensor &out) {
    CUSTOM_OP_NOT_IMPL
}
::std::tuple<at::Tensor, at::Tensor, at::Tensor> npu_conv3d_backward(const at::Tensor &input, const at::Tensor &grad, const at::Tensor &weight,
                                                                     at::IntArrayRef stride, at::IntArrayRef padding, at::IntArrayRef dilation, int64_t groups,
                                                                     ::std::array<bool, 3> output_mask){CUSTOM_OP_NOT_IMPL} at::Tensor
    npu_stride_add(const at::Tensor &self, const at::Tensor &other, const at::Scalar &offset1, const at::Scalar &offset2,
                   const at::Scalar &c1_len){CUSTOM_OP_NOT_IMPL} at::Tensor npu_slice(const at::Tensor &self, at::IntArrayRef offsets, at::IntArrayRef size) {
    CUSTOM_OP_NOT_IMPL
}
__attribute__((__visibility__("default"))) at::Tensor &npu_slice_out(const at::Tensor &self, at::IntArrayRef offsets, at::IntArrayRef size, at::Tensor &out){
    CUSTOM_OP_NOT_IMPL} at::Tensor npu_indexing(const at::Tensor &self, at::IntArrayRef begin, at::IntArrayRef end, at::IntArrayRef strides, int64_t begin_mask,
                                                int64_t end_mask, int64_t ellipsis_mask, int64_t new_axis_mask, int64_t shrink_axis_mask){
    CUSTOM_OP_NOT_IMPL} at::Tensor &npu_indexing_out(const at::Tensor &self, at::IntArrayRef begin, at::IntArrayRef end, at::IntArrayRef strides,
                                                     int64_t begin_mask, int64_t end_mask, int64_t ellipsis_mask, int64_t new_axis_mask,
                                                     int64_t shrink_axis_mask, at::Tensor &out){CUSTOM_OP_NOT_IMPL} at::Tensor
    npu_softmax_cross_entropy_with_logits_backward(const at::Tensor &grad, const at::Tensor &self, const at::Tensor &labels){CUSTOM_OP_NOT_IMPL} at::Tensor
    npu_stride_copy(const at::Tensor &self, at::IntArrayRef shape, at::IntArrayRef stride, const at::Scalar &storage_offset){
        CUSTOM_OP_NOT_IMPL} at::Tensor &npu_stride_copy_out(const at::Tensor &self, at::IntArrayRef shape, at::IntArrayRef stride,
                                                            const at::Scalar &storage_offset, at::Tensor &out){CUSTOM_OP_NOT_IMPL} at::Tensor
    npu_roi_align(const at::Tensor &self, const at::Tensor &rois, double spatial_scale, int64_t pooled_height, int64_t pooled_width, int64_t sample_num,
                  int64_t roi_end_mode){CUSTOM_OP_NOT_IMPL} at::Tensor
    npu_roi_alignbk(const at::Tensor &self, const at::Tensor &rois, at::IntArrayRef xdiff_shape, int64_t pooled_width, int64_t pooled_height,
                    double spatial_scale, int64_t sample_num, c10::optional<int64_t> roi_end_mode){
        CUSTOM_OP_NOT_IMPL} at::Tensor &npu_sort_v2_out(const at::Tensor &self, int64_t dim, bool descending, at::Tensor &out){CUSTOM_OP_NOT_IMPL} at::Tensor
    npu_sort_v2(const at::Tensor &self, int64_t dim, bool descending){CUSTOM_OP_NOT_IMPL} at::Tensor
    npu_one_hot(const at::Tensor &self, int64_t num_classes, int64_t depth, const at::Scalar &on_value, const at::Scalar &off_value) {
    CUSTOM_OP_NOT_IMPL
}
::std::tuple<at::Tensor, at::Tensor> npu_linear_backward(const at::Tensor &grad, const at::Tensor &input, const at::Tensor &weight){
    CUSTOM_OP_NOT_IMPL} at::Tensor npu_anchor_response_flags(const at::Tensor &self, at::IntArrayRef featmap_size, at::IntArrayRef stride,
                                                             int64_t num_base_anchors){CUSTOM_OP_NOT_IMPL} at::Tensor
    npu_dropout_backward(const at::Tensor &grad_output, const at::Tensor &mask, double p) {
    CUSTOM_OP_NOT_IMPL
}
::std::tuple<at::Tensor, at::Tensor> npu_nms_rotated(const at::Tensor &self, const at::Tensor &scores, double iou_threshold, double scores_threshold,
                                                     int64_t max_output_size, int64_t mode){CUSTOM_OP_NOT_IMPL} at::Tensor
    npu_masked_fill_range(const at::Tensor &self, const at::Tensor &start, const at::Tensor &end, const at::Tensor &value, int64_t axis){
        CUSTOM_OP_NOT_IMPL} at::Tensor npu_sub_sample(const at::Tensor &self, int64_t per_images, double positive_fraction){CUSTOM_OP_NOT_IMPL} at::Tensor
    npu_yolo_boxes_encode(const at::Tensor &self, const at::Tensor &gt_bboxes, const at::Tensor &stride, bool performance_mode){CUSTOM_OP_NOT_IMPL} at::Tensor
    npu_scatter(const at::Tensor &self, const at::Tensor &indices, const at::Tensor &updates, int64_t dim){CUSTOM_OP_NOT_IMPL} at::Tensor
    npu_layer_norm_eval(const at::Tensor &input, at::IntArrayRef normalized_shape, const c10::optional<at::Tensor> &weight,
                        const c10::optional<at::Tensor> &bias, double eps){CUSTOM_OP_NOT_IMPL} at::Tensor
    npu_rotated_box_encode(const at::Tensor &self, const at::Tensor &gt_bboxes, const at::Tensor &weight){CUSTOM_OP_NOT_IMPL} at::Tensor
    npu_rotated_box_decode(const at::Tensor &self, const at::Tensor &deltas, const at::Tensor &weight){CUSTOM_OP_NOT_IMPL} at::Tensor
    npu_rotated_overlaps(const at::Tensor &self, const at::Tensor &query_boxes, bool trans){CUSTOM_OP_NOT_IMPL} at::Tensor
    npu_silu_backward(const at::Tensor &grad_output, const at::Tensor &x0, const at::Tensor &x1){CUSTOM_OP_NOT_IMPL} at::Tensor
    npu_rotated_iou(const at::Tensor &self, const at::Tensor &query_boxes, bool trans, int64_t mode, bool is_cross, double v_threshold, double e_threshold) {
    CUSTOM_OP_NOT_IMPL
}
...
::std::tuple<at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor> npu_gru_backward(
    ...
    const at::Tensor &hidden_new){CUSTOM_OP_NOT_IMPL} at::Tensor
    npu_mish_backward(const at::Tensor &grad, const at::Tensor &input){CUSTOM_OP_NOT_IMPL} at::Tensor
    npu_reshape(const at::Tensor &self, at::IntArrayRef shape, bool can_refresh){
        CUSTOM_OP_NOT_IMPL} at::Tensor &npu_reshape_out(const at::Tensor &self, at::IntArrayRef shape, bool can_refresh, at::Tensor &out) {
    CUSTOM_OP_NOT_IMPL
}
::std::tuple<at::Tensor, at::Tensor, at::Tensor, at::Tensor> npu_batch_nms(const at::Tensor &self, const at::Tensor &scores, double score_threshold,
                                                                           ...
                                                                           bool change_coordinate_frame, bool transpose_box){CUSTOM_OP_NOT_IMPL} at::Tensor
    npu_bounding_box_encode(const at::Tensor &anchor_box, const at::Tensor &ground_truth_box, double means0, double means1, double means2, double means3,
                            double stds0, double stds1, double stds2, double stds3){CUSTOM_OP_NOT_IMPL} at::Tensor
    npu_bounding_box_decode(const at::Tensor &rois, const at::Tensor &deltas, double means0, double means1, double means2, double means3, double stds0,
...
::std::tuple<at::Tensor, at::Tensor> npu_diou_backward(const at::Tensor &grad, const at::Tensor &bboxes, const at::Tensor &gtboxes, bool trans, bool is_cross,
                                                       int64_t mode){CUSTOM_OP_NOT_IMPL} at::Tensor
    npu_iou(const at::Tensor &bboxes, const at::Tensor &gtboxes, int64_t mode) {
    CUSTOM_OP_NOT_IMPL
}
::std::tuple<at::Tensor, at::Tensor> npu_nms_v4(const at::Tensor &self, const at::Tensor &scores, const at::Scalar &max_output_size,
    ...
    CUSTOM_OP_NOT_IMPL} at::Tensor npu_pad(const at::Tensor &input, at::IntArrayRef paddings) {
    CUSTOM_OP_NOT_IMPL
}
::std::tuple<at::Tensor, at::Tensor> npu_random_choice_with_mask(const at::Tensor &x, int64_t count, int64_t seed, int64_t seed2){CUSTOM_OP_NOT_IMPL} at::Tensor
    npu_normalize_batch(const at::Tensor &self, const at::Tensor &seq_len, int64_t normalize_type){CUSTOM_OP_NOT_IMPL} at::Tensor
    npu_ptiou(const at::Tensor &bboxes, const at::Tensor &gtboxes, int64_t mode) {
    CUSTOM_OP_NOT_IMPL
}
::std::tuple<at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor> npu_lstm_backward(
    ...
    const at::Tensor &c_output, const at::Tensor &i, const at::Tensor &j, const at::Tensor &f, const at::Tensor &o,
    const at::Tensor &tanhc){CUSTOM_OP_NOT_IMPL} at::Tensor
    _dropout_with_byte_mask_backward(const at::Tensor &grad_output, const at::Tensor &mask, double p){CUSTOM_OP_NOT_IMPL} at::Tensor
    dropout_with_byte_mask(const at::Tensor &self, double p, bool train) {
    CUSTOM_OP_NOT_IMPL
}
...
npu_multi_head_attention_backward(const at::Tensor &query, const at::Tensor &key, const at::Tensor &value, const at::Tensor &query_weight,
                                  ...
                                  int64_t attn_dim_per_head, int64_t src_len, int64_t tgt_len, double dropout_prob,
                                  bool softmax_use_float){CUSTOM_OP_NOT_IMPL} at::Tensor
    npu_dropout_gen_mask(at::IntArrayRef size, double p, c10::optional<at::ScalarType> dtype, c10::optional<at::Layout> layout,
...
::std::tuple<at::Tensor, at::Tensor> npu_ciou_backward(const at::Tensor &grad, const at::Tensor &bboxes, const at::Tensor &gtboxes,
                                                       const c10::optional<at::Tensor> &atan_sub, bool trans, bool is_cross,
                                                       int64_t mode){CUSTOM_OP_NOT_IMPL} at::Tensor
    npu_sign_bits_unpack(const at::Tensor &input, int64_t size, at::ScalarType dtype){CUSTOM_OP_NOT_IMPL} at::Tensor
    decode_jpeg(const at::Tensor &self, at::IntArrayRef image_shape, int64_t channels, bool try_recover_truncated){CUSTOM_OP_NOT_IMPL} at::Tensor
    crop_and_resize(const at::Tensor &self, c10::optional<at::ArrayRef<double>> boxes, at::IntArrayRef box_index, at::IntArrayRef crop_size,
                    double extrapolation_value, c10::string_view method){CUSTOM_OP_NOT_IMPL} at::Tensor
    reverse(const at::Tensor &self, at::IntArrayRef axis){CUSTOM_OP_NOT_IMPL} at::Tensor
    image_normalize(const at::Tensor &self, c10::optional<at::ArrayRef<double>> mean, c10::optional<at::ArrayRef<double>> variance, int64_t dtype){
        CUSTOM_OP_NOT_IMPL} at::Tensor &image_normalize_(at::Tensor &self, c10::optional<at::ArrayRef<double>> mean,
                                                         c10::optional<at::ArrayRef<double>> variance, int64_t dtype){CUSTOM_OP_NOT_IMPL} at::Tensor
    img_to_tensor(const at::Tensor &self) {
    CUSTOM_OP_NOT_IMPL
}
...
::std::tuple<at::Tensor, at::Tensor> npu_ifmr(const at::Tensor &data, const at::Tensor &data_min, const at::Tensor &data_max, const at::Tensor &cumsum,
                                              ...
                                              bool with_offset){CUSTOM_OP_NOT_IMPL} at::Tensor
    npu_grid_assign_positive(const at::Tensor &self, const at::Tensor &overlaps, const at::Tensor &box_responsible_flags, const at::Tensor &max_overlaps,
                             const at::Tensor &argmax_overlaps, const at::Tensor &gt_max_overlaps, const at::Tensor &gt_argmax_overlaps, int64_t num_gts,
                             double pos_iou_thr, double min_pos_iou, bool gt_max_assign_all){CUSTOM_OP_NOT_IMPL} at::Tensor
    npu_rotary_mul(const at::Tensor &self, const at::Tensor &r1, const at::Tensor &r2) {
    CUSTOM_OP_NOT_IMPL
}
::std::tuple<at::Tensor, at::Tensor, at::Tensor> npu_rotary_mul_backward(const at::Tensor &grad, const at::Tensor &self, const at::Tensor &r1,
                                                                         const at::Tensor &r2){CUSTOM_OP_NOT_IMPL} at::Tensor
    npu_convolution(const at::Tensor &input, const at::Tensor &weight, const c10::optional<at::Tensor> &bias, at::IntArrayRef stride, at::IntArrayRef padding,
                    at::IntArrayRef dilation, int64_t groups){CUSTOM_OP_NOT_IMPL} at::Tensor
    npu_convolution_transpose(const at::Tensor &input, const at::Tensor &weight, const c10::optional<at::Tensor> &bias, at::IntArrayRef padding,
                              at::IntArrayRef output_padding, at::IntArrayRef stride, at::IntArrayRef dilation, int64_t groups){CUSTOM_OP_NOT_IMPL} at::Tensor
    npu_confusion_transpose(const at::Tensor &self, at::IntArrayRef perm, at::IntArrayRef shape, bool transpose_first){CUSTOM_OP_NOT_IMPL} at::Tensor
    npu_ps_roi_pooling(const at::Tensor &self, const at::Tensor &rois, double spatial_scale, int64_t group_size, int64_t output_dim){
        CUSTOM_OP_NOT_IMPL} at::Tensor npu_linear(const at::Tensor &input, const at::Tensor &weight, const c10::optional<at::Tensor> &bias) {
    CUSTOM_OP_NOT_IMPL
}
::std::tuple<at::Tensor, at::Tensor> _npu_dropout(const at::Tensor &self, double p){CUSTOM_OP_NOT_IMPL} at::Tensor
    npu_softmax_cross_entropy_with_logits(const at::Tensor &self, const at::Tensor &labels) {
    CUSTOM_OP_NOT_IMPL
}
::std::tuple<at::Tensor, at::Tensor> npu_max(const at::Tensor &self, int64_t dim, bool keepdim) { CUSTOM_OP_NOT_IMPL }
::std::tuple<at::Tensor, at::Tensor> npu_max(const at::Tensor &self, at::Dimname dim, bool keepdim){CUSTOM_OP_NOT_IMPL} at::Tensor
    npu_bmmV2(const at::Tensor &self, const at::Tensor &mat2, at::IntArrayRef output_sizes){CUSTOM_OP_NOT_IMPL}

at::Tensor npu_dtype_cast(const at::Tensor &self, at::ScalarType dtype) {
    return acl_op::npu_dtype_cast(self, dtype);
}

at::Tensor npu_silu(const at::Tensor &self){CUSTOM_OP_NOT_IMPL} at::Tensor &npu_silu_(at::Tensor &self) { CUSTOM_OP_NOT_IMPL }
::std::tuple<at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor> npu_gru(
    ...
    bool batch_first){CUSTOM_OP_NOT_IMPL} at::Tensor npu_mish(const at::Tensor &self) {
    CUSTOM_OP_NOT_IMPL
}
...
::std::tuple<at::Tensor, at::Tensor> npu_deformable_conv2d(const at::Tensor &input, const at::Tensor &weight, const at::Tensor &offset,
                                                           ...
                                                           bool modulated){CUSTOM_OP_NOT_IMPL} at::Tensor
    npu_giou(const at::Tensor &self, const at::Tensor &gtboxes, bool trans, bool is_cross, int64_t mode){CUSTOM_OP_NOT_IMPL} at::Tensor
    npu_diou(const at::Tensor &self, const at::Tensor &gtboxes, bool trans, bool is_cross, int64_t mode) {
    CUSTOM_OP_NOT_IMPL
}
...
::std::tuple<at::Tensor, at::Tensor, at::Tensor> npu_dropout_with_add_softmax(const at::Tensor &self, const at::Tensor &x1, const at::Scalar &alpha,
                                                                              double prob, int64_t dim){CUSTOM_OP_NOT_IMPL} at::Tensor
    npu_scaled_masked_softmax(const at::Tensor &x, const at::Tensor &mask, const at::Scalar &scale, bool fixed_triu_mask) {
    CUSTOM_OP_NOT_IMPL
}
...
::std::tuple<at::Tensor, at::Tensor> npu_dropout_do_mask(const at::Tensor &self, const at::Tensor &mask, double p){CUSTOM_OP_NOT_IMPL} at::Tensor
    npu_ciou(const at::Tensor &self, const at::Tensor &gtboxes, bool trans, bool is_cross, int64_t mode, bool atan_sub_flag) {
    CUSTOM_OP_NOT_IMPL
}
::std::tuple<at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor, at::Tensor> npu_lstm_cell(
    ...
    const c10::optional<at::Tensor> &bias){CUSTOM_OP_NOT_IMPL} at::Tensor
    npu_fused_attention_score(const at::Tensor &query_layer, const at::Tensor &key_layer, const at::Tensor &value_layer, const at::Tensor &attention_mask,
