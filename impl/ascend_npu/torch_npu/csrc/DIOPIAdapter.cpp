...
inline at::Tensor apply_tensor_use_empty(c10::IntArrayRef sizes, const c10::TensorOptions &options) {
    return NPUNativeFunctions::empty(
        c10::fromIntArrayRefUnchecked(sizes), options.dtype().toScalarType(), c10::nullopt,
...
at::Tensor OpPreparation::apply_tensor_without_format(c10::IntArrayRef sizes, const c10::TensorOptions& options) { return apply_tensor_use_empty(sizes, options); }
