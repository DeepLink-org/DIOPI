...
static std::map<std::string, SocVersion> socVersionMap = {{"Ascend910PremiumA", SocVersion::Ascend910PremiumA},
...
bool IsSupportInfNan() { return (GetSocVersion() >= SocVersion::Ascend910B1); }
}  // namespace c10_npu
