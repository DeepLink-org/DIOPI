...
diopiError_t diopiFlashAttentionV2(diopiContextHandle_t ctx, diopiTensorHandle_t attentionOut, diopiTensorHandle_t* dropoutMask,
                                   ...
                                   diopiConstTensorHandle_t attentionMask, double pDropout, double softmaxScale, int64_t headNum) {
    ...
    // at::Tensor attentionMaskAt = at::Tensor(); if (isCausal) {
...
diopiError_t diopiFlashAttentionBackwardV2(diopiContextHandle_t ctx, diopiTensorHandle_t gradQ, diopiTensorHandle_t gradK, diopiTensorHandle_t gradV,
