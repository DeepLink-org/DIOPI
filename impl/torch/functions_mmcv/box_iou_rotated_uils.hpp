...
HOST_DEVICE_INLINE T single_box_iou_quadri(T const* const pts1_raw, T const* const pts2_raw, const int mode_flag) {
    ...
    auto center_shift_x = (pts1_raw[0] + pts2_raw[0] + pts1_raw[2] + pts2_raw[2] + pts1_raw[4] + pts2_raw[4] + pts1_raw[6] + pts2_raw[6]) / 8.0;
    auto center_shift_y = (pts1_raw[1] + pts2_raw[1] + pts1_raw[3] + pts2_raw[3] + pts1_raw[5] + pts2_raw[5] + pts1_raw[7] + pts2_raw[7]) / 8.0;
