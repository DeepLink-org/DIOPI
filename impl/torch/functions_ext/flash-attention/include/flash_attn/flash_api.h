...
__attribute__((weak)) std::vector<at::Tensor> mha_varlen_bwd(
...
__attribute__((weak)) std::vector<at::Tensor> mha_fwd_kvcache(at::Tensor &q, const at::Tensor &kcache, const at::Tensor &vcache, const at::Tensor &k,
